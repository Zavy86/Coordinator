...
function content(){
 ...
 if($file->id){
  ...
  if($link->id){$form->addControl("button",api_text("uploads_links_edit-fc-delete"),"btn-danger","submit.php?act=link_delete&idLink=".$link->id,api_text("uploads_links_edit-fc-delete-confirm"));}
 }else{
