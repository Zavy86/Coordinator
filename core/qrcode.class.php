...
/**
 * Usage:
 * 1. Include qrcode.class.php library in your script
 * require_once("qrcode.class.php");
 * 2. create a cQRCode object
 * $qr = new cQRCode("Class QRCode",ECL_M);
 ...
 * The image is generate in tmp directory, see FILE_PATH constant in qrcode.class.php library
 * Yo can change the module size in pixels, see PXS constant in qrcode.class.php library
 * You can see, step by step, the process to generate QR Codes if you active DEBUG mode, see DEBUG and DEBUG_LEVEL constants in qrcode.class.php library
 **/
/**
 * Constans
 **/
 ...
 DEFINE ("ROW",1);
//image
DEFINE ("PXS",2); //pixel size default: 4
DEFINE ("QZ", 3); //quiet zone default: 4
DEFINE ("PNG",0); 
DEFINE ("GIF",1); 
DEFINE ("JPG",2); 
...
class cQRCode{
    ...
    //create image
    public function getQRImg($format,$filename = "noname", $rounded = false){
            if($filename != "noname"){
                //$filename = dirname(__FILE__).FILE_PATH.$filename;
        ...
        switch($this->format){
            ...
            case JPG:
                if($saveFile){
                    imagejpeg($finalGd, $filename.".jpg");
                }else{
