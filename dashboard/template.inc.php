...
$nt_array=array();
$nt_array[]=api_navigationTab(api_text("notifications"),"notifications_list.php?s=1","&q=test");
$nt_array[]=api_navigationTab(api_text("archived-notifications"),"notifications_list.php?s=2","&q=test");
