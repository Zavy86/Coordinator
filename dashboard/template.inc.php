...
<div class="row-fluid">
 ...
 <ul class="nav nav-tabs">
  ...
  <?php
   if(api_checkPermission("projects","projects_view")){
    echo "<li";if(api_baseName()=="projects_activities.php"){echo " class='active'";}
    echo "><a href='projects_activities.php?s=2'";
    echo ">Incarichi</a></li>";
   }
  ?>
  
  <?php
   if(api_checkPermission("organics","addressbook_view")){
    echo "<li";if(api_baseName()=="addressbook_list.php"){echo " class='active'";}
    echo "><a href='addressbook_list.php'";
    echo ">Rubrica aziendale</a></li>";
   }
  ?>
